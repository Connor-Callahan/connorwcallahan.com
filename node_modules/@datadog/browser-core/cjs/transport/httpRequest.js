...
function fetchKeepAliveStrategy(endpointBuilder, bytesLimit, _a, onResponse) {
    ...
    if (canUseKeepAlive) {
        ...
        fetch(fetchUrl, { method: 'POST', body: data, keepalive: true }).then((0, monitor_1.monitor)(function (response) { return onResponse === null || onResponse === void 0 ? void 0 : onResponse({ status: response.status }); }), (0, monitor_1.monitor)(function () {
